...
namespace Undersoft.Picatch
{
	...
	public void Loaddata ()
		...
		private void InitializeComponent()
		{
			...
			this.exit_b.Location = new System.Drawing.Point(120, 264);
			...
			this.delete.Location = new System.Drawing.Point(5, 264);
			...
			this.edit.Location = new System.Drawing.Point(120, 224);
			...
			this.add_b.Location = new System.Drawing.Point(5, 224);
			...
			this.label2.Text = "POZYCJE DOKUMENTU";
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			try
			{
				Form2 frm2 = new Form2(rownum, lic, "", 0);
				frm2.Show();
				this.Close();
			}
			catch (Exception c)
